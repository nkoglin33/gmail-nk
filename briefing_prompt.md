...
Write the complete HTML email string to a file called `output.html` in the working directory using the Write tool. Do not output the HTML to the conversation — write it directly to the file only.

---

## STEP 4 — Send the email

Read `output.html`, then use Bash to POST to the Make.com webhook:
...
Replace `SUBJECT_LINE_HERE` with the actual subject line from Step 2.
